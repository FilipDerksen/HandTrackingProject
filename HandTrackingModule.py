...
def main():
    """
    Main function to demonstrate hand tracking functionality.
    
    This function initializes the camera, creates a hand detector, and runs
    a continuous loop to detect and display hand landmarks with FPS counter.
    """
    ...
    while True:
        ...
        # Print landmark 4 (tip of thumb) if hands are detected
